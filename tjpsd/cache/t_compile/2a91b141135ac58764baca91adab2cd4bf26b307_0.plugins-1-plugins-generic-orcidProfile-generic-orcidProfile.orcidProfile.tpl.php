...
function content_698f058cac7639_04367318 (Smarty_Internal_Template $_smarty_tpl) {
	...
	$(document).ready(function() {
        ...
        var orcidLinkOrButton = $(
        	<?php if ($_smarty_tpl->tpl_vars['orcid']->value) {?>
        		<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'json_encode' ][ 0 ], array( $_smarty_tpl->tpl_vars['orcidLink']->value ));?>

        	<?php } else { ?>
        		<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'json_encode' ][ 0 ], array( $_smarty_tpl->tpl_vars['orcidButton']->value ));?>
...
<?php if ($_smarty_tpl->tpl_vars['targetOp']->value == 'register') {?>
	<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"hidden",'name'=>"orcid",'id'=>"orcid",'value'=>$_smarty_tpl->tpl_vars['orcid']->value,'maxlength'=>"46"),$_smarty_tpl ) );?>

	<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"hidden",'name'=>"orcidAccessToken",'id'=>"orcidAccessToken",'value'=>$_smarty_tpl->tpl_vars['orcidAccessToken']->value),$_smarty_tpl ) );?>

	<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"hidden",'name'=>"orcidAccessScope",'id'=>"orcidAccessScope",'value'=>$_smarty_tpl->tpl_vars['orcidAccessScope']->value),$_smarty_tpl ) );?>

	<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"hidden",'name'=>"orcidRefreshToken",'id'=>"orcidRefreshToken",'value'=>$_smarty_tpl->tpl_vars['orcidRefreshToken']->value),$_smarty_tpl ) );?>

	<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"hidden",'name'=>"orcidAccessExpiresOn",'id'=>"orcidAccessExpiresOn",'value'=>$_smarty_tpl->tpl_vars['orcidAccessExpiresOn']->value),$_smarty_tpl ) );?>
