<?php
/* Smarty version 4.3.1, created on 2026-02-13 13:24:10
  from 'app:controllersgridfilessubmissionDocumentsformnewFileForm.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_698f17ea5d96c3_38047109',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c5d4d0c8a14ea6265e12852fd4675601f82f5b60' => 
    array (
      0 => 'app:controllersgridfilessubmissionDocumentsformnewFileForm.tpl',
      1 => 1770978291,
      2 => 'app',
    ),
  ),
...
function content_698f17ea5d96c3_38047109 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
	...
	$(function() {
		$('#uploadForm').pkpHandler(
			'$.pkp.controllers.form.FileUploadFormHandler',
			{
				$uploader: $('#plupload'),
				uploaderOptions: {
					uploadUrl: <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'json_encode' ][ 0 ], array( call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('op'=>"uploadFile",'fileType'=>$_smarty_tpl->tpl_vars['fileType']->value,'submissionId'=>$_smarty_tpl->tpl_vars['submissionId']->value,'escape'=>false),$_smarty_tpl ) ) ));?>
,
...
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('fbvFormArea', array('id'=>"description"));
$_block_repeat=true;
echo $_block_plugin5->smartyFBVFormArea(array('id'=>"description"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('fbvFormSection', array('title'=>"common.description",'required'=>true));
$_block_repeat=true;
echo $_block_plugin6->smartyFBVFormSection(array('title'=>"common.description",'required'=>true), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"textarea",'multilingual'=>"true",'id'=>"description",'value'=>$_smarty_tpl->tpl_vars['description']->value),$_smarty_tpl ) );?>

		<?php $_block_repeat=false;
echo $_block_plugin6->smartyFBVFormSection(array('title'=>"common.description",'required'=>true), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
	<?php $_block_repeat=false;
echo $_block_plugin5->smartyFBVFormArea(array('id'=>"description"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin7->smartyFBVFormArea(array('id'=>"file"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin8->smartyFBVFormSection(array('title'=>"common.file",'required'=>true), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
?>
		<?php $_block_repeat=false;
echo $_block_plugin8->smartyFBVFormSection(array('title'=>"common.file",'required'=>true), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
	<?php $_block_repeat=false;
echo $_block_plugin7->smartyFBVFormArea(array('id'=>"file"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
